    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden" style={{ backgroundColor: '#3b8fc2' }}>
      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl p-10 w-full max-w-md">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? (
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Only @acmetalent.com and @chessat3.sg emails are allowed
        </p>
      </div>
    </div>
  );
